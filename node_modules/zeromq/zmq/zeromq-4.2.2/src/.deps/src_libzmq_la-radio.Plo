src/src_libzmq_la-radio.lo: src/radio.cpp src/precompiled.hpp \
  ...
  src/socket_base.hpp src/own.hpp \
  /Library/Developer/CommandLineTools/usr/bin/../include/c++/v1/set \
  src/object.hpp src/stdint.hpp src/options.hpp src/tcp_address.hpp \
  ...
  src/i_engine.hpp src/i_encoder.hpp src/i_decoder.hpp src/mtrie.hpp \
  src/dist.hpp src/macros.hpp
