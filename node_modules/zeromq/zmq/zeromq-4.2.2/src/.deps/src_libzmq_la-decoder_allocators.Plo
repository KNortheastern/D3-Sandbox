src/src_libzmq_la-decoder_allocators.lo: src/decoder_allocators.cpp \
  ...
  src/zmq_draft.h src/decoder_allocators.hpp \
  ...
  src/atomic_counter.hpp src/stdint.hpp src/msg.hpp src/config.hpp \
  src/fd.hpp src/metadata.hpp \
