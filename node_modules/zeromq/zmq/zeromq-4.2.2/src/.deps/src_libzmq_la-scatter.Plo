src/src_libzmq_la-scatter.lo: src/scatter.cpp src/precompiled.hpp \
  ...
  src/zmq_draft.h src/macros.hpp src/scatter.hpp src/socket_base.hpp \
  ...
  src/i_engine.hpp src/i_encoder.hpp src/i_decoder.hpp src/lb.hpp
