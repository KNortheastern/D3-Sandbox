src/src_libzmq_la-io_object.lo: src/io_object.cpp src/precompiled.hpp \
  ...
  src/zmq_draft.h src/io_object.hpp src/stdint.hpp src/poller.hpp \
  src/kqueue.hpp \
  ...
  src/i_poll_events.hpp src/io_thread.hpp src/object.hpp
