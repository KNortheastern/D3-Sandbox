src/src_libzmq_la-curve_client.lo: src/curve_client.cpp \
  ...
  src/zmq_draft.h src/macros.hpp src/msg.hpp src/config.hpp src/fd.hpp \
  src/atomic_counter.hpp src/stdint.hpp src/metadata.hpp \
  ...
  src/session_base.hpp src/own.hpp \
  /Library/Developer/CommandLineTools/usr/bin/../include/c++/v1/set \
  src/object.hpp src/options.hpp \
  ...
  src/io_object.hpp src/poller.hpp src/kqueue.hpp \
  ...
  src/ctx.hpp src/mailbox.hpp src/signaler.hpp src/command.hpp \
  ...
  src/i_poll_events.hpp src/pipe.hpp src/blob.hpp src/socket_base.hpp \
  src/stream_engine.hpp src/i_engine.hpp src/i_encoder.hpp \
  src/i_decoder.hpp src/curve_client.hpp src/tweetnacl.h \
  src/mechanism.hpp src/wire.hpp
