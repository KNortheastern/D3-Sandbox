src/src_libzmq_la-lb.lo: src/lb.cpp src/precompiled.hpp src/platform.hpp \
  src/../include/zmq.h \
  ...
  src/zmq_draft.h src/lb.hpp src/array.hpp \
  ...
  src/pipe.hpp src/msg.hpp src/config.hpp src/fd.hpp \
