src/src_libzmq_la-plain_client.lo: src/plain_client.cpp \
  ...
  src/likely.hpp src/plain_client.hpp src/mechanism.hpp src/options.hpp \
  ...
  src/tcp_address.hpp src/blob.hpp
