src/src_libzmq_la-reaper.lo: src/reaper.cpp src/precompiled.hpp \
  ...
  src/zmq_draft.h src/macros.hpp src/reaper.hpp src/object.hpp \
  ...
  src/stdint.hpp src/mailbox.hpp src/signaler.hpp \
  ...
  src/i_mailbox.hpp src/poller.hpp src/kqueue.hpp \
  ...
  src/i_poll_events.hpp src/socket_base.hpp src/own.hpp src/blob.hpp \
  src/pipe.hpp src/msg.hpp src/metadata.hpp
