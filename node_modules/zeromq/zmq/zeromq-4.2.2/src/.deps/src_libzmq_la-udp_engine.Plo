src/src_libzmq_la-udp_engine.lo: src/udp_engine.cpp src/precompiled.hpp \
  ...
  src/udp_engine.hpp src/io_object.hpp src/stdint.hpp src/poller.hpp \
  src/kqueue.hpp \
  ...
  src/i_poll_events.hpp src/i_engine.hpp src/address.hpp \
  src/udp_address.hpp src/msg.hpp src/metadata.hpp src/session_base.hpp \
  src/own.hpp src/object.hpp src/pipe.hpp src/blob.hpp \
  src/socket_base.hpp src/stream_engine.hpp src/i_encoder.hpp \
  src/i_decoder.hpp src/v2_protocol.hpp src/ip.hpp
