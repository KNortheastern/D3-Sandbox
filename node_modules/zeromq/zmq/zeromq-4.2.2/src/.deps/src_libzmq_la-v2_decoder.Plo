src/src_libzmq_la-v2_decoder.lo: src/v2_decoder.cpp src/precompiled.hpp \
  ...
  src/v2_protocol.hpp src/v2_decoder.hpp src/decoder.hpp \
  ...
  src/decoder_allocators.hpp src/atomic_counter.hpp src/stdint.hpp \
  src/msg.hpp src/config.hpp src/fd.hpp src/metadata.hpp \
  ...
  src/likely.hpp src/i_decoder.hpp src/wire.hpp
