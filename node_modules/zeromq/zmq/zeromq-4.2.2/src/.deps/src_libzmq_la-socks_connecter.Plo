src/src_libzmq_la-socks_connecter.lo: src/socks_connecter.cpp \
  ...
  src/macros.hpp src/socks_connecter.hpp src/fd.hpp src/io_object.hpp \
  ...
  src/i_poll_events.hpp src/own.hpp src/object.hpp src/socks.hpp \
  src/stream_engine.hpp src/i_engine.hpp src/i_encoder.hpp \
  src/i_decoder.hpp src/socket_base.hpp src/blob.hpp src/pipe.hpp \
  src/msg.hpp src/metadata.hpp src/random.hpp src/ip.hpp src/tcp.hpp \
  src/address.hpp src/session_base.hpp
