src/src_libzmq_la-zmq.lo: src/zmq.cpp src/precompiled.hpp \
  ...
  src/zmq_draft.h src/macros.hpp src/poller.hpp src/kqueue.hpp \
  ...
  src/blob.hpp src/i_poll_events.hpp src/pipe.hpp src/msg.hpp \
  src/metadata.hpp src/socket_poller.hpp src/timers.hpp
