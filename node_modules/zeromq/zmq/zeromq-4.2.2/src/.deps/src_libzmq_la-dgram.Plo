src/src_libzmq_la-dgram.lo: src/dgram.cpp src/precompiled.hpp \
  ...
  src/zmq_draft.h src/macros.hpp src/dgram.hpp src/blob.hpp \
  ...
  src/atomic_counter.hpp src/array.hpp src/poller.hpp src/kqueue.hpp \
  ...
  src/i_engine.hpp src/i_encoder.hpp src/i_decoder.hpp src/wire.hpp \
  src/random.hpp
