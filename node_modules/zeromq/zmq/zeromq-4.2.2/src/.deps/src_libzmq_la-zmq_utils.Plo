src/src_libzmq_la-zmq_utils.lo: src/zmq_utils.cpp src/precompiled.hpp \
  ...
  src/zmq_draft.h src/macros.hpp src/clock.hpp src/stdint.hpp \
  ...
  src/atomic_counter.hpp src/atomic_ptr.hpp \
