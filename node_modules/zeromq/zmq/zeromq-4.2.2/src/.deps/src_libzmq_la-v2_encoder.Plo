src/src_libzmq_la-v2_encoder.lo: src/v2_encoder.cpp src/precompiled.hpp \
  ...
  src/zmq_draft.h src/v2_protocol.hpp src/v2_encoder.hpp src/encoder.hpp \
  ...
  src/i_encoder.hpp src/wire.hpp
