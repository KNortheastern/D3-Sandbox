src/src_libzmq_la-sub.lo: src/sub.cpp src/precompiled.hpp \
  ...
  src/zmq_draft.h src/sub.hpp src/xsub.hpp src/socket_base.hpp \
  ...
  src/i_engine.hpp src/i_encoder.hpp src/i_decoder.hpp src/dist.hpp \
