src/src_libzmq_la-raw_encoder.lo: src/raw_encoder.cpp src/precompiled.hpp \
  ...
  src/zmq_draft.h src/encoder.hpp \
  ...
  src/i_encoder.hpp src/raw_encoder.hpp src/wire.hpp
