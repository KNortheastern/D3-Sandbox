src/src_libzmq_la-address.lo: src/address.cpp src/precompiled.hpp \
  ...
  src/zmq_draft.h src/macros.hpp src/address.hpp \
  ...
  src/fd.hpp src/config.hpp src/command.hpp src/stdint.hpp src/ypipe.hpp \
  ...
  src/udp_address.hpp src/ipc_address.hpp \
