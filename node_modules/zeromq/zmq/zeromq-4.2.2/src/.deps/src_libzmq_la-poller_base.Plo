src/src_libzmq_la-poller_base.lo: src/poller_base.cpp src/precompiled.hpp \
  ...
  src/zmq_draft.h src/poller_base.hpp \
  ...
  src/atomic_counter.hpp src/i_poll_events.hpp src/err.hpp \
