src/src_libzmq_la-stream.lo: src/stream.cpp src/precompiled.hpp \
  ...
  src/zmq_draft.h src/macros.hpp src/stream.hpp \
  ...
  src/router.hpp src/socket_base.hpp \
  ...
  src/ctx.hpp src/mailbox.hpp src/signaler.hpp src/fd.hpp src/config.hpp \
  ...
  src/session_base.hpp src/io_object.hpp src/stream_engine.hpp \
  src/i_engine.hpp src/i_encoder.hpp src/i_decoder.hpp src/fq.hpp \
  src/wire.hpp src/random.hpp
