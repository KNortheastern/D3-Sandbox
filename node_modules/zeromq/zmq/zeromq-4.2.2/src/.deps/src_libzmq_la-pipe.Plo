src/src_libzmq_la-pipe.lo: src/pipe.cpp src/precompiled.hpp \
  ...
  src/macros.hpp src/pipe.hpp src/msg.hpp src/config.hpp src/fd.hpp \
  ...
  src/ypipe_base.hpp src/object.hpp src/array.hpp \
  ...
  src/likely.hpp src/ypipe.hpp src/atomic_ptr.hpp src/yqueue.hpp \
  src/ypipe_conflate.hpp src/dbuffer.hpp src/mutex.hpp \
