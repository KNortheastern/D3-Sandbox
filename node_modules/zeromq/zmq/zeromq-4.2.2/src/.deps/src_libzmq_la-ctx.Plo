src/src_libzmq_la-ctx.lo: src/ctx.cpp src/precompiled.hpp \
  ...
  src/command.hpp src/stdint.hpp src/ypipe.hpp src/atomic_ptr.hpp \
  ...
  src/io_thread.hpp src/reaper.hpp src/tweetnacl.h
