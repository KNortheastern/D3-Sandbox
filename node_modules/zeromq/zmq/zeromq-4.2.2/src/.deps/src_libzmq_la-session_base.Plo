src/src_libzmq_la-session_base.lo: src/session_base.cpp \
  ...
  src/zmq_draft.h src/macros.hpp src/session_base.hpp \
  ...
  src/atomic_counter.hpp src/io_object.hpp src/poller.hpp src/kqueue.hpp \
  ...
  src/mailbox.hpp src/signaler.hpp src/fd.hpp src/config.hpp \
  ...
  src/i_mailbox.hpp src/array.hpp src/thread.hpp src/poller_base.hpp \
  src/clock.hpp \
  ...
  src/blob.hpp src/socket_base.hpp src/stream_engine.hpp \
  src/i_engine.hpp src/i_encoder.hpp src/i_decoder.hpp \
  src/tcp_connecter.hpp src/ipc_connecter.hpp src/tipc_connecter.hpp \
  src/socks_connecter.hpp src/socks.hpp src/vmci_connecter.hpp \
  src/pgm_sender.hpp src/pgm_receiver.hpp src/address.hpp \
  src/norm_engine.hpp src/udp_engine.hpp src/udp_address.hpp src/req.hpp \
  src/dealer.hpp src/fq.hpp src/lb.hpp src/radio.hpp src/mtrie.hpp \
  src/dist.hpp src/dish.hpp src/trie.hpp
