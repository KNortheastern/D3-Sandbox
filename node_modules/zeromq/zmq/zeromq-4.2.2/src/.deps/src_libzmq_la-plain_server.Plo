src/src_libzmq_la-plain_server.lo: src/plain_server.cpp \
  ...
  src/msg.hpp src/config.hpp src/fd.hpp src/atomic_counter.hpp \
  src/stdint.hpp src/metadata.hpp \
  ...
  src/i_decoder.hpp src/plain_server.hpp src/mechanism.hpp src/wire.hpp
