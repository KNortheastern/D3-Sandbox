src/src_libzmq_la-fq.lo: src/fq.cpp src/precompiled.hpp src/platform.hpp \
  src/../include/zmq.h \
  ...
  src/zmq_draft.h src/fq.hpp src/array.hpp \
  ...
  src/ypipe_base.hpp src/object.hpp src/err.hpp \
