src/src_libzmq_la-tcp_connecter.lo: src/tcp_connecter.cpp \
  ...
  src/macros.hpp src/tcp_connecter.hpp src/fd.hpp src/own.hpp \
  ...
  src/i_poll_events.hpp src/stream_engine.hpp src/i_engine.hpp \
  src/i_encoder.hpp src/i_decoder.hpp src/socket_base.hpp src/blob.hpp \
  src/pipe.hpp src/msg.hpp src/metadata.hpp src/io_thread.hpp \
  src/random.hpp src/ip.hpp src/tcp.hpp src/address.hpp \
