src/src_libzmq_la-null_mechanism.lo: src/null_mechanism.cpp \
  ...
  src/likely.hpp src/msg.hpp src/config.hpp src/fd.hpp \
  ...
  src/tcp_address.hpp src/io_object.hpp src/poller.hpp src/kqueue.hpp \
  ...
  src/ypipe.hpp src/atomic_ptr.hpp src/yqueue.hpp src/ypipe_base.hpp \
  src/mutex.hpp \
  ...
  src/i_decoder.hpp src/wire.hpp src/null_mechanism.hpp \
  src/mechanism.hpp
