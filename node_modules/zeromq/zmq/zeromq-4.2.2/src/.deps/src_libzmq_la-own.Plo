src/src_libzmq_la-own.lo: src/own.cpp src/precompiled.hpp \
  ...
  src/atomic_counter.hpp src/err.hpp \
  /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netdb.h \
  src/likely.hpp src/io_thread.hpp src/poller.hpp src/kqueue.hpp \
  ...
  src/ypipe_base.hpp src/mutex.hpp \
