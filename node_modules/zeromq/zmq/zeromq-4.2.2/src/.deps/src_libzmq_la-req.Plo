src/src_libzmq_la-req.lo: src/req.cpp src/precompiled.hpp \
  ...
  src/zmq_draft.h src/macros.hpp src/req.hpp src/dealer.hpp \
  src/socket_base.hpp \
  ...
  src/lb.hpp src/wire.hpp src/random.hpp
