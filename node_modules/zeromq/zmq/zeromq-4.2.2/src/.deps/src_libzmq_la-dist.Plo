src/src_libzmq_la-dist.lo: src/dist.cpp src/precompiled.hpp \
  ...
  src/array.hpp src/pipe.hpp src/msg.hpp src/config.hpp src/fd.hpp \
  ...
  src/ypipe_base.hpp src/object.hpp src/blob.hpp src/err.hpp \
